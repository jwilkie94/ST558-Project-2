...
linear_fit_2 <- train(shares~self_reference_avg_sharess+weekday_is_tuesday+weekday_is_wednesday+weekday_is_thursday+global_rate_positive_words:global_rate_negative_words+num_imgs+num_videos, data=training, method = "lm", trControl=trainControl(method="cv", number=10),preProcess = c("center", "scale"))
