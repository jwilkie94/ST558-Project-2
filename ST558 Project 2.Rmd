...
set.seed(89)
boosted_tree_fit <-
  train(shares ~ self_reference_avg_sharess+weekday_is_tuesday+weekday_is_wednesday+weekday_is_thursday+global_rate_positive_words:global_rate_negative_words+num_imgs+num_videos, data=training, method = "gbm", trControl=trainControl(method="cv", number=10),preProcess = c("center", "scale"), tuneGrid=expand.grid(n.trees=c(20,50,100,150,200), interaction.depth = c(1,2,3,4), shrinkage = 0.1, n.minobsinnode = 10))
